...
Bridge.assembly("PixelRPG.Base", function ($asm, globals) {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage", {
        $kind: "interface"
    });
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage", {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.Components.ServerComponent", {
        ...
        ctors: {
            init: function () {
                this.Request = new (System.Collections.Generic.Dictionary$2(System.Int32,System.Collections.Generic.Queue$1(PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage)))();
                this.Response = new (System.Collections.Generic.Dictionary$2(System.Int32,System.Collections.Generic.Queue$1(PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage)))();
            }
        }
    });
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                if (client.Message != null) {
                    ...
                    var parser = PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.FindWriter(transferMessage, this.parsers);
                    var data = parser.PixelRPG$Base$AdditionalStuff$ClientServer$ITransferMessageParser$Write(transferMessage);
                    localServer.Request.get(localClient.Identifier).Enqueue(data);
                    ($t = (Bridge.as(client.Message, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage))) != null ? $t.PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free() : null;
                    client.Message = null;
                }

                var response = localServer.Response.get(localClient.Identifier);
                ($t1 = (Bridge.as(client.Response, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage))) != null ? $t1.PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free() : null;
                client.Response = null;
                if (response.Count > 0) {
                    var data1 = response.Dequeue();
                    var parser1 = PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.FindReader(data1, this.parsers);
                    var transferMessage1 = parser1.PixelRPG$Base$AdditionalStuff$ClientServer$ITransferMessageParser$Read(data1);
            ...
            DoAction$1: function (entity, gameTime) {
                ...
                if (localServer.PendingConnections.Count > 0) {
                    for (var i = 0; i < localServer.PendingConnections.Count; i = (i + 1) | 0) {
                        ...
                        server.Request.set(localServer.ClientToConnectionKey.get(tcpClient), new (System.Collections.Generic.Queue$1(PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage)).ctor());
                        server.Response.set(localServer.ClientToConnectionKey.get(tcpClient), new (System.Collections.Generic.Queue$1(PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage)).ctor());
                ...
                for (var i1 = 0; i1 < localServer.Clients.Count; i1 = (i1 + 1) | 0) {
                    ...
                    if (localServer.Request.containsKey(client) && localServer.Request.get(client).Count > 0) {
                        ...
                        while (request.Count > 0) {
                            ...
                            var parser = PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.FindReader(data, this.parsers);
                            var transferMessage = parser.PixelRPG$Base$AdditionalStuff$ClientServer$ITransferMessageParser$Read(data);
                    ...
                    if (server.Response.containsKey(connectionKey) && server.Response.get(connectionKey).Count > 0) {
                        ...
                        while (response.Count > 0) {
                            ...
                            var parser1 = PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.FindWriter(transferMessage1, this.parsers);
                            var data1 = parser1.PixelRPG$Base$AdditionalStuff$ClientServer$ITransferMessageParser$Write(transferMessage1);
                            localServer.Response.get(client).Enqueue(data1);
                            ($t = (Bridge.as(transferMessage1, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage))) != null ? $t.PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free() : null;
                        }
                    }
                }
            }
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.NetworkClientCommunicatorSystem", {
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                ($t = (Bridge.as(client.Response, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage))) != null ? $t.PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free() : null;
                client.Response = null;
                ...
                if (client.Message != null) {
                    ...
                    ($t1 = (Bridge.as(client.Message, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage))) != null ? $t1.PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free() : null;
                    client.Message = null;
                    return;
                }
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (!server.Response.containsKey(req.key)) {
                            server.Response.set(req.key, new (System.Collections.Generic.Queue$1(PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage)).ctor());
                        }

                        var request = req.value;
                        while (request.Count > 0) {
                            var transferMessage = request.Dequeue();
                            this.handlers.get(Bridge.getType(transferMessage)).PixelRPG$Base$AdditionalStuff$ClientServer$EntitySystems$ServerReceiveHandlerSystem$IHandler$Handle(server, req.key, transferMessage);
                            (Bridge.as(transferMessage, PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage)).PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free();
                        }
                    }
                } finally {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils", {
        statics: {
            fields: {
            ...
            ctors: {
                ctor: function () {
                    PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.AvailableParsers = System.Array.init([new PixelRPG.Base.AdditionalStuff.ClientServer.ClientConnectTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ClientTurnDoneTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerClientConnectedTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerCurrentStateTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerGameStartedTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerPlayerTurnMadeTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerYouConnectedTransferMessageParser(), new PixelRPG.Base.AdditionalStuff.ClientServer.ServerYourTurnTransferMessageParser()], PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessageParser);
                }
            },
            methods: {
                FindWriter: function (transferModel, parsers) {
                    if (parsers === void 0) { parsers = null; }
                    parsers = parsers || PixelRPG.Base.AdditionalStuff.ClientServer.TransferMessageParserUtils.AvailableParsers;
                    if (parsers == null) {
    ...
    Bridge.define("PixelRPG.Base.Components.GameState.Player", {
        fields: {
            PlayerId: 0,
            Units: null,
            PlayerName: null,
    ...
    Bridge.apply($asm.$.PixelRPG.Base.Components.GameState.UnitUtils, {
        f1: function (_o1) {
            ...
            _o1.add(PixelRPG.Base.Components.GameState.UnitUtils.UnitType.Bat, ($t = new PixelRPG.Base.Components.GameState.Unit(), $t.MoveRange = 3, $t.MaxHp = 5, $t.Hp = 5, $t));
            return _o1;
        },
        f2: function (_o2) {
    ...
    Bridge.define("PixelRPG.Base.Components.GameStateComponent", {
        ...
        ctors: {
            init: function () {
                ...
                this.Doors = new (System.Collections.Generic.List$1(Microsoft.Xna.Framework.Point)).ctor();
                this.Players = new (System.Collections.Generic.Dictionary$2(System.Int32,PixelRPG.Base.Components.GameState.Player))();
                this.MaxUnitsCount = 4;
                this.MaxSkillsCount = 1;
                this.CurrentTurn = new (System.Collections.Generic.Dictionary$2(System.Int64,PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler.UnitAction))();
                this.PlayersMoved = new (System.Collections.Generic.HashSet$1(System.Int32)).ctor();
            ...
            DoAction$1: function (entity, gameTime) {
                ...
                switch (charSprites.State) {
                    ...
                    case PixelRPG.Base.Assets.UnitState.Run: 
                        ...
                        animation.IsPlaying = true;
                        break;
                    case PixelRPG.Base.Assets.UnitState.Dead: 
                        if (Bridge.referenceEquals(animation.Animation, charSprites.UnitAnimations.Die)) {
                            return;
                        }
        ...
        statics: {
            methods: {
                BuildCurrentStateForPlayer: function (gameState, player) {
                    var $t;
                    var result = PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.Create();

                    var width = System.Array.getLength(gameState.Map, 0);
                    var height = System.Array.getLength(gameState.Map, 1);
                    for (var x = 0; x < width; x = (x + 1) | 0) {
                        for (var y = 0; y < height; y = (y + 1) | 0) {
                            result.Map.add(PixelRPG.Base.EntitySystems.ServerLogic.IsVisible(player, gameState.Exit.X, gameState.Exit.Y, x, y) ? gameState.Map.get([x, y]) : null);
                        }
                    }

                    var idx = 0;
                    $t = Bridge.getEnumerator(gameState.Players.getValues(), PixelRPG.Base.Components.GameState.Player);
                    try {
                        while ($t.moveNext()) {
                            var statePlayer = $t.Current;
                            result.AddPlayer(statePlayer.PlayerId, statePlayer.LevelScore, statePlayer.TotalScore);
                            for (var j = 0; j < statePlayer.Units.Count; j = (j + 1) | 0) {
                                var b = statePlayer.Units.getItem(j);
                                if (!PixelRPG.Base.EntitySystems.ServerLogic.IsVisible(player, gameState.Exit.X, gameState.Exit.Y, b.Position.X, b.Position.Y) && player.PlayerId !== statePlayer.PlayerId) {
                                    continue;
                                }
                    ...
                    if (PixelRPG.Base.EntitySystems.ServerLogic.IsVisible(player, gameState.Exit.X, gameState.Exit.Y, gameState.Exit.X, gameState.Exit.Y)) {
                        result.SetExit(gameState.Exit.X, gameState.Exit.Y);
                    }
                    for (var i = 0; i < gameState.Doors.Count; i = (i + 1) | 0) {
                        var door = gameState.Doors.getItem(i).$clone();
                        if (!PixelRPG.Base.EntitySystems.ServerLogic.IsVisible(player, gameState.Exit.X, gameState.Exit.Y, door.X, door.Y)) {
                            continue;
                        }
                ...
                IsVisible: function (fromPlayer, exitX, exitY, x, y) {
                    ...
                    for (var i1 = 0; i1 < fromPlayer.Units.Count; i1 = (i1 + 1) | 0) {
                        var unit1 = fromPlayer.Units.getItem(i1);
                        if (unit1.Hp <= 0) {
                            continue;
                        }

                        if (unit1.Position.X === exitX && unit1.Position.Y === exitY) {
                            return true;
                        }

                        if (((Math.abs(((x - unit1.Position.X) | 0)) + Math.abs(((y - unit1.Position.Y) | 0))) | 0) < unit1.VisionRange) {
                            return true;
                        }
                    }
                    return false;
                ...
                StartNewGame: function (gameState) {
                    ...
                    var maze = new MazeGenerators.RoomMazeGenerator().Generate(($t = new MazeGenerators.RoomMazeGenerator.Settings(), $t.Width = 71, $t.Height = 41, $t.AdditionalPassages = 20, $t.WindingPercent = 50, $t.RoomSize = 3, $t));
                    gameState.Map = maze.Regions;
                    gameState.Doors.clear();
                    for (var i = 0; i < maze.Junctions.Count; i = (i + 1) | 0) {
                        gameState.Doors.add(new Microsoft.Xna.Framework.Point.$ctor2(maze.Junctions.getItem(i).$clone().X, maze.Junctions.getItem(i).$clone().Y));
                    }

                    for (var x = 0; x < System.Array.getLength(gameState.Map, 0); x = (x + 1) | 0) {
                        for (var y = 0; y < System.Array.getLength(gameState.Map, 1); y = (y + 1) | 0) {
                            gameState.Map.set([x, y], gameState.Map.get([x, y]) == null ? PixelRPG.Base.Screens.GameSceneConfig.WallRegionValue : PixelRPG.Base.Screens.GameSceneConfig.PathRegionValue);
                        }
                    }
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            var room = maze.Rooms.getItem(roomIdx).$clone();
                            roomIdx = (roomIdx + 1) | 0;
                            ...
                            for (var i1 = 0; i1 < player.value.Units.Count; i1 = (i1 + 1) | 0) {
                                player.value.Units.getItem(i1).Hp = player.value.Units.getItem(i1).MaxHp;
                            }
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
                    ...
                    gameState.Exit = new Microsoft.Xna.Framework.Point.$ctor2(((maze.Rooms.getItem(((maze.Rooms.Count - 1) | 0)).$clone().X + ((Bridge.Int.div(maze.Rooms.getItem(((maze.Rooms.Count - 1) | 0)).$clone().Width, 2)) | 0)) | 0), ((maze.Rooms.getItem(((maze.Rooms.Count - 1) | 0)).$clone().Y + ((Bridge.Int.div(maze.Rooms.getItem(((maze.Rooms.Count - 1) | 0)).$clone().Height, 2)) | 0)) | 0));
                },
                GetFullUnitId: function (player, unit) {
                    return PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId$1(player.PlayerId, unit.UnitId);
                },
                GetFullUnitId$1: function (playerId, unitId) {
                    return (System.Int64(playerId).shl(32)).or((System.Int64(unitId).and(System.Int64([-1,0]))));
                }
            }
        }
    });

    Bridge.define("PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler.UnitAction", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler.UnitAction).Obtain();
                }
            }
        },
        fields: {
            NewPositionX: 0,
            NewPositionY: 0,
            AttackDirectionX: null,
            AttackDirectionY: null
        },
        alias: ["Reset", "SpineEngine$Utils$Collections$IPoolable$Reset"],
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler.UnitAction).Free(this);
            },
            Reset: function () {
                this.NewPositionX = 0;
                this.NewPositionY = 0;
    ...
    Bridge.define("PixelRPG.Base.Screens.AIPlayerState", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.Units = new (System.Collections.Generic.List$1(PixelRPG.Base.Screens.AIPlayerState.UnitSubMessage)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState).Free(this);
            },
            Reset: function () {
                this.PlayerId = 0;
                this.LevelScore = 0;
                this.TotalScore = 0;
                for (var i = 0; i < this.Units.Count; i = (i + 1) | 0) {
                    this.Units.getItem(i).Free();
                }
    ...
    Bridge.define("PixelRPG.Base.Screens.AIPlayerState.PointSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState.PointSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState.PointSubMessage).Free(this);
            },
            Reset: function () {
                this.X = 0;
                this.Y = 0;
    ...
    Bridge.define("PixelRPG.Base.Screens.AIPlayerState.UnitSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState.UnitSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPlayerState.UnitSubMessage).Free(this);
            },
            Reset: function () {
                this.UnitId = 0;
                this.Hp = 0;
                this.Position != null ? this.Position.Free() : null;
                this.Position = null;
            }
        }
    });

    Bridge.define("PixelRPG.Base.Screens.AIPoint", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPoint).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIPoint).Free(this);
            },
            Reset: function () {
                this.X = 0;
                this.Y = 0;
    ...
    Bridge.define("PixelRPG.Base.Screens.AIUnitDescription", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIUnitDescription).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.Screens.AIUnitDescription).Free(this);
            },
            Reset: function () {
                this.UnitType = 0;
                this.UnitId = 0;
    ...
    Bridge.define("PixelRPG.Base.Screens.GameScene", {
        ...
        ctors: {
            ctor: function (config) {
                ...
                this.AddEntitySystem(new PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.NetworkServerCommunicatorSystem());
                this.AddEntitySystem(new PixelRPG.Base.EntitySystems.ClientReceiveServerGameStartedVisibleSystem(this));
                this.AddEntitySystem(new PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.LocalClientCommunicatorSystem(this));
                ...
                this.AddEntitySystem(new PixelRPG.Base.EntitySystems.ClientSendClientConnectDoneAISystem());
                ...
                this.AddEntitySystem(new PixelRPG.Base.EntitySystems.ClientReceiveServerClientConnectedVisibleSystem(this));
                ...
                if (config.IsServer) {
                    ...
                    for (var i = 0; i < config.ClientsCount; i = (i + 1) | 0) {
                        ...
                        player.AddComponent(PixelRPG.Base.AdditionalStuff.ClientServer.Components.ClientComponent);
                    ...
                    for (var i1 = 0; i1 < config.ClientsCount; i1 = (i1 + 1) | 0) {
                        ...
                        player1.AddComponent(PixelRPG.Base.AdditionalStuff.ClientServer.Components.ClientComponent);
    ...
    Bridge.define("PixelRPG.Base.Screens.SimpleAI", {
        ...
        ctors: {
            init: function () {
                this.Players = new (System.Collections.Generic.List$1(PixelRPG.Base.Screens.AIPlayerState)).ctor();
                this.SearchPoint = new (System.Collections.Generic.Dictionary$2(System.Int32,PixelRPG.Base.Screens.AIPoint))();
                this.UnitDesription = new (System.Collections.Generic.Dictionary$2(System.Int32,PixelRPG.Base.Screens.AIUnitDescription))();
                this.PlayerName = System.String.format("Player Bot.", null);
            }
        },
        methods: {
            Tick: function () { },
            GetNextTurn: function () {
                var $t, $t1, $t2;
                var me = this.FindMe();
                var result = PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.Create();

                for (var i = 0; i < me.Units.Count; i = (i + 1) | 0) {
                    if (!this.SearchPoint.containsKey(me.Units.getItem(i).UnitId)) {
                        this.SearchPoint.set(me.Units.getItem(i).UnitId, null);
                    }

                    if (this.SearchPoint.get(me.Units.getItem(i).UnitId) == null || (this.SearchPoint.get(me.Units.getItem(i).UnitId).X === me.Units.getItem(i).Position.X && this.SearchPoint.get(me.Units.getItem(i).UnitId).Y === me.Units.getItem(i).Position.Y)) {

                        ($t = this.SearchPoint.get(me.Units.getItem(i).UnitId)) != null ? $t.Free() : null;
                        this.SearchPoint.set(me.Units.getItem(i).UnitId, PixelRPG.Base.Screens.AIPoint.Create());
                        this.SearchPoint.get(me.Units.getItem(i).UnitId).X = FateRandom.Fate.GlobalFate.NextInt(System.Array.getLength(this.Regions, 0));
                        this.SearchPoint.get(me.Units.getItem(i).UnitId).Y = FateRandom.Fate.GlobalFate.NextInt(System.Array.getLength(this.Regions, 1));
                    }

                    var pathToGo = this.Exit || this.SearchPoint.get(me.Units.getItem(i).UnitId);
                    ...
                    if (path == null || path.Count < 2) {
                        ($t1 = this.SearchPoint.get(me.Units.getItem(i).UnitId)) != null ? $t1.Free() : null;
                        this.SearchPoint.set(me.Units.getItem(i).UnitId, null);
                        continue;
                    }
                    ...
                    for (var j = 0; j < me.Units.Count; j = (j + 1) | 0) {
                        if (me.Units.getItem(j).Position.X === path.getItem(1).$clone().X && me.Units.getItem(j).Position.Y === path.getItem(1).$clone().Y) {
                            ($t2 = this.SearchPoint.get(me.Units.getItem(i).UnitId)) != null ? $t2.Free() : null;
                            this.SearchPoint.set(me.Units.getItem(i).UnitId, null);
                        }
                    }
                    var unitDescription = this.UnitDesription.get(me.Units.getItem(i).UnitId);

                    var distance = Math.min(unitDescription.MoveRange, ((path.Count - 1) | 0));

                    result.SetNewPosition(me.Units.getItem(i).UnitId, path.getItem(distance).$clone().X, path.getItem(distance).$clone().Y);
                    if (!unitDescription.AttackFriendlyFire) {
                        result.SetAttackDirection(me.Units.getItem(i).UnitId, 0, 0);
                    }
                }
            ...
            GetPlayerData: function () {
                return PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.Create().SetPlayerName(this.PlayerName).AddUnitType(PixelRPG.Base.Components.GameState.UnitUtils.UnitType.Ranger).AddUnitType(PixelRPG.Base.Components.GameState.UnitUtils.UnitType.Rogue).AddSkill(0, PixelRPG.Base.Components.GameState.UnitUtils.Skill.VisionRange).AddSkill(1, PixelRPG.Base.Components.GameState.UnitUtils.Skill.MoveRange);
            },
            FindMe: function () {
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.UnitSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.UnitSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.Skills = new (System.Collections.Generic.List$1(PixelRPG.Base.Components.GameState.UnitUtils.Skill)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.UnitSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    if (this.Skills != null) {
                        for (var thisSkillsIndex = 0; thisSkillsIndex < this.Skills.Count; thisSkillsIndex = (thisSkillsIndex + 1) | 0) {
                            var thisSkillsListValue = this.Skills.getItem(thisSkillsIndex);
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.PointSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.PointSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.PointSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.X = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.AttackDirection != null ? this.AttackDirection.Free() : null;
                    this.AttackDirection = null;
                    this.NewPosition != null ? this.NewPosition.Free() : null;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.UnitSubMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.UnitSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.UnitSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.UnitId = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PlayerSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PlayerSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.Units = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.UnitSubMessage)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PlayerSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.LevelScore = 0;
                    ...
                    this.TotalScore = 0;
                    if (this.Units != null) {
                        for (var thisUnitsIndex = 0; thisUnitsIndex < this.Units.Count; thisUnitsIndex = (thisUnitsIndex + 1) | 0) {
                            var thisUnitsListValue = { v : this.Units.getItem(thisUnitsIndex) };
                            thisUnitsListValue.v != null ? thisUnitsListValue.v.Free() : null;
                            thisUnitsListValue.v = null;
                        }
                    }
                    this.Units.clear();
                }
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.X = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.UnitSubMessage", {
        inherits: [SpineEngine.Utils.Collections.IPoolable],
        $kind: "nested class",
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.UnitSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.UnitSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.Hp = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.UnitSubMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.UnitSubMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.UnitSubMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.AttackDamage = 0;
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.ClientReceiveHandlerSystem$1", function (T) { return {
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                this.DoAction$2(Bridge.cast(Bridge.unbox(client.Response, T), T), entity, gameTime);
            }
        }
    }; });
    ...
    Bridge.define("PixelRPG.Base.Components.GameState.Skills.MoveRangeSkill", {
        inherits: [PixelRPG.Base.Components.GameState.ISkill],
        alias: ["Apply", "PixelRPG$Base$Components$GameState$ISkill$Apply"],
        methods: {
            Apply: function (player, unit) {
                unit.MoveRange = (unit.MoveRange + 1) | 0;
            }
        }
    });

    Bridge.define("PixelRPG.Base.Components.GameState.Skills.VisionRangeSkill", {
        inherits: [PixelRPG.Base.Components.GameState.ISkill],
        alias: ["Apply", "PixelRPG$Base$Components$GameState$ISkill$Apply"],
        methods: {
            Apply: function (player, unit) {
                unit.VisionRange = (unit.VisionRange + 2) | 0;
            }
        }
    });

    Bridge.define("PixelRPG.Base.TransferMessages.ClientConnectTransferMessage", {
        inherits: [PixelRPG.Base.AdditionalStuff.ClientServer.ITransferMessage,PixelRPG.Base.AdditionalStuff.ClientServer.IPoolableTransferMessage],
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        alias: [
            "Free", "PixelRPG$Base$AdditionalStuff$ClientServer$IPoolableTransferMessage$Free",
            "Reset", "SpineEngine$Utils$Collections$IPoolable$Reset"
        ],
        ctors: {
            init: function () {
                this.UnitsData = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.UnitSubMessage)).ctor();
            }
        },
        methods: {
            AddSkill: function (unitIndex, value) {
                this.UnitsData.getItem(unitIndex).Skills.add(value);
                return this;
            },
            AddUnitType: function (value) {
                var unit = PixelRPG.Base.TransferMessages.ClientConnectTransferMessage.UnitSubMessage.Create();
                unit.UnitType = value;
            ...
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.PlayerName = null;
                    if (this.UnitsData != null) {
                        for (var thisUnitsDataIndex = 0; thisUnitsDataIndex < this.UnitsData.Count; thisUnitsDataIndex = (thisUnitsDataIndex + 1) | 0) {
                            var thisUnitsDataListValue = { v : this.UnitsData.getItem(thisUnitsDataIndex) };
                            thisUnitsDataListValue.v != null ? thisUnitsDataListValue.v.Free() : null;
                            thisUnitsDataListValue.v = null;
                        }
                    }
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.UnitActions = new (System.Collections.Generic.Dictionary$2(System.Int32,PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage))();
            }
        },
        methods: {
            SetNewPosition: function (unitId, x, y) {
                if (!this.UnitActions.containsKey(unitId)) {
                    this.UnitActions.set(unitId, PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage.Create());
                }

                this.UnitActions.get(unitId).NewPosition = this.UnitActions.get(unitId).NewPosition || PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.PointSubMessage.Create();
                this.UnitActions.get(unitId).NewPosition.X = x;
                this.UnitActions.get(unitId).NewPosition.Y = y;
                return this;
            },
            SetAttackDirection: function (unitId, x, y) {
                if (!this.UnitActions.containsKey(unitId)) {
                    this.UnitActions.set(unitId, PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.UnitActionSubMessage.Create());
                }

                this.UnitActions.get(unitId).AttackDirection = this.UnitActions.get(unitId).AttackDirection || PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage.PointSubMessage.Create();
                this.UnitActions.get(unitId).AttackDirection.X = x;
                this.UnitActions.get(unitId).AttackDirection.Y = y;
                return this;
            },
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ClientTurnDoneTransferMessage).Free(this);
            },
            Reset: function () {
                var $t;
                if (this != null) {
                    if (this.UnitActions != null) {
                        $t = Bridge.getEnumerator(this.UnitActions);
                        try {
                            while ($t.moveNext()) {
                                var thisUnitActionsKVP = $t.Current;
                                var thisUnitActionsKVPKey = thisUnitActionsKVP.key;
                                var thisUnitActionsKVPValue = { v : thisUnitActionsKVP.value };
                                thisUnitActionsKVPKey = 0;
                                thisUnitActionsKVPValue.v != null ? thisUnitActionsKVPValue.v.Free() : null;
                                thisUnitActionsKVPValue.v = null;
                            }
                        } finally {
                            if (Bridge.is($t, System.IDisposable)) {
                                $t.System$IDisposable$Dispose();
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.Units = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.UnitSubMessage)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.CurrentCount = 0;
            ...
            SetData: function (playerId, playerName, waitingCount, currentCount) {
            ...
            AddUnit: function (unitId, unitType) {
                var unitData = PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.UnitSubMessage.Create();
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.Players = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PlayerSubMessage)).ctor();
                this.Map = new (System.Collections.Generic.List$1(System.Nullable$1(System.Int32))).ctor();
                this.Doors = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    if (this.Doors != null) {
                        for (var thisDoorsIndex = 0; thisDoorsIndex < this.Doors.Count; thisDoorsIndex = (thisDoorsIndex + 1) | 0) {
                            var thisDoorsListValue = { v : this.Doors.getItem(thisDoorsIndex) };
                            thisDoorsListValue.v != null ? thisDoorsListValue.v.Free() : null;
                            thisDoorsListValue.v = null;
                        }
                    }
                    this.Doors.clear();
                    this.Exit != null ? this.Exit.Free() : null;
                    this.Exit = null;
                    if (this.Map != null) {
                        for (var thisMapIndex = 0; thisMapIndex < this.Map.Count; thisMapIndex = (thisMapIndex + 1) | 0) {
                            var thisMapListValue = this.Map.getItem(thisMapIndex);
                            thisMapListValue = null;
                        }
                    }
                    this.Map.clear();
                    if (this.Players != null) {
                        for (var thisPlayersIndex = 0; thisPlayersIndex < this.Players.Count; thisPlayersIndex = (thisPlayersIndex + 1) | 0) {
                            var thisPlayersListValue = { v : this.Players.getItem(thisPlayersIndex) };
                            thisPlayersListValue.v != null ? thisPlayersListValue.v.Free() : null;
                            thisPlayersListValue.v = null;
                        }
                    }
                    this.Players.clear();
                }
            },
            AddPlayer: function (playerId, levelScore, totalScore) {
                var responsePlayer = PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PlayerSubMessage.Create();
            ...
            AddUnit: function (playerIndex, unitId, posX, posY, hp) {
                var unit = PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.UnitSubMessage.Create();
                unit.Hp = hp;
                unit.UnitId = unitId;
                unit.Position = PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage.Create();
                unit.Position.X = posX;
                unit.Position.Y = posY;
                this.Players.getItem(playerIndex).Units.add(unit);
                return this;
            },
            SetExit: function (x, y) {
                this.Exit = this.Exit || PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage.Create();
                this.Exit.X = x;
                this.Exit.Y = y;
                return this;
            },
            AddDoor: function (x, y) {
                var door = PixelRPG.Base.TransferMessages.ServerCurrentStateTransferMessage.PointSubMessage.Create();
                door.X = x;
                door.Y = y;
                this.Doors.add(door);
                return this;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerGameStartedTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerGameStartedTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerGameStartedTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.Height = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerPlayerTurnMadeTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerPlayerTurnMadeTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerPlayerTurnMadeTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.PlayerId = 0;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage).Obtain();
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.UnitsData = new (System.Collections.Generic.List$1(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.UnitSubMessage)).ctor();
            }
        },
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                    this.PlayerId = 0;
            ...
            PopulateUnits: function (units) {
                for (var i = 0; i < units.Count; i = (i + 1) | 0) {
                    var newUnit = units.getItem(i);
                    this.AddUnit(newUnit.UnitId, newUnit.UnitType, newUnit.VisionRange, newUnit.MoveRange, newUnit.AttackDamage, newUnit.AttackDistance, newUnit.AttackFriendlyFire, newUnit.AttackRadius, newUnit.Hp, newUnit.MaxHp);
                }

                return this;
            },
            AddUnit: function (unitId, unitType, visionRange, moveRange, attackDamage, attackDistance, attackFriendlyFire, attackRadius, hp, maxHp) {
                var unit = PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.UnitSubMessage.Create();
                unit.UnitId = unitId;
                unit.UnitType = unitType;
    ...
    Bridge.define("PixelRPG.Base.TransferMessages.ServerYourTurnTransferMessage", {
        ...
        statics: {
            methods: {
                Create: function () {
                    return SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYourTurnTransferMessage).Obtain();
                }
            }
        },
        alias: [
        ...
        methods: {
            Free: function () {
                SpineEngine.Utils.Collections.Pool$1(PixelRPG.Base.TransferMessages.ServerYourTurnTransferMessage).Free(this);
            },
            Reset: function () {
                if (this != null) {
                }
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ClientConnectTransferMessageParser", {
            ...
            InternalWrite: function (transferModel, writer) {
                ...
                if (transferModel != null) {
                    ...
                    if (transferModel.UnitsData != null) {
                        writer.Write$10(transferModel.UnitsData.Count);
                        for (var transferModelUnitsDataIndex = 0; transferModelUnitsDataIndex < transferModel.UnitsData.Count; transferModelUnitsDataIndex = (transferModelUnitsDataIndex + 1) | 0) {
                            writer.Write(transferModel.UnitsData.getItem(transferModelUnitsDataIndex) != null);
                            if (transferModel.UnitsData.getItem(transferModelUnitsDataIndex) != null) {
                                writer.Write(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).Skills != null);
            ...
            InternalRead: function (reader) {
                ...
                if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelUnitsDataIndex = 0; transferModelUnitsDataIndex < transferModelUnitsDataCount; transferModelUnitsDataIndex = (transferModelUnitsDataIndex + 1) | 0) {
                            var transferModelUnitsDataValue = null;
                            if (reader.ReadBoolean()) {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ClientTurnDoneTransferMessageParser", {
            ...
            InternalWrite: function (transferModel, writer) {
                ...
                if (transferModel != null) {
                    ...
                    if (transferModel.UnitActions != null) {
                        writer.Write$10(transferModel.UnitActions.count);
                        $t = Bridge.getEnumerator(transferModel.UnitActions);
                        try {
                            while ($t.moveNext()) {
                                var transferModelUnitActionsKVP = $t.Current;
            ...
            InternalRead: function (reader) {
                ...
                if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelUnitActionsIndex = 0; transferModelUnitActionsIndex < transferModelUnitActionsCount; transferModelUnitActionsIndex = (transferModelUnitActionsIndex + 1) | 0) {
                            var transferModelUnitActionsKey = Bridge.getDefaultValue(System.Int32);
                            var transferModelUnitActionsValue = null;
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerClientConnectedTransferMessageParser", {
            ...
            InternalWrite: function (transferModel, writer) {
                ...
                if (transferModel != null) {
                    ...
                    if (transferModel.Units != null) {
                        writer.Write$10(transferModel.Units.Count);
                        for (var transferModelUnitsIndex = 0; transferModelUnitsIndex < transferModel.Units.Count; transferModelUnitsIndex = (transferModelUnitsIndex + 1) | 0) {
            ...
            InternalRead: function (reader) {
                ...
                if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelUnitsIndex = 0; transferModelUnitsIndex < transferModelUnitsCount; transferModelUnitsIndex = (transferModelUnitsIndex + 1) | 0) {
                            var transferModelUnitsValue = null;
                            if (reader.ReadBoolean()) {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerCurrentStateTransferMessageParser", {
            ...
            InternalWrite: function (transferModel, writer) {
                ...
                if (transferModel != null) {
                    ...
                    if (transferModel.Doors != null) {
                        ...
                        for (var transferModelDoorsIndex = 0; transferModelDoorsIndex < transferModel.Doors.Count; transferModelDoorsIndex = (transferModelDoorsIndex + 1) | 0) {
                            writer.Write(transferModel.Doors.getItem(transferModelDoorsIndex) != null);
                            if (transferModel.Doors.getItem(transferModelDoorsIndex) != null) {
                                writer.Write$10(transferModel.Doors.getItem(transferModelDoorsIndex).X);
                                writer.Write$10(transferModel.Doors.getItem(transferModelDoorsIndex).Y);
                            }
                        }
                    }
                    writer.Write(transferModel.Exit != null);
                    if (transferModel.Exit != null) {
                        writer.Write$10(transferModel.Exit.X);
                        writer.Write$10(transferModel.Exit.Y);
                    }
                    writer.Write(transferModel.Map != null);
                    if (transferModel.Map != null) {
                        writer.Write$10(transferModel.Map.Count);
                        for (var transferModelMapIndex = 0; transferModelMapIndex < transferModel.Map.Count; transferModelMapIndex = (transferModelMapIndex + 1) | 0) {
                            writer.Write(transferModel.Map.getItem(transferModelMapIndex) != null);
                            if (transferModel.Map.getItem(transferModelMapIndex) != null) {
                                writer.Write$10(System.Nullable.getValue(transferModel.Map.getItem(transferModelMapIndex)));
                            }
                        }
                    }
                        ...
                        for (var transferModelPlayersIndex = 0; transferModelPlayersIndex < transferModel.Players.Count; transferModelPlayersIndex = (transferModelPlayersIndex + 1) | 0) {
                            ...
                            if (transferModel.Players.getItem(transferModelPlayersIndex) != null) {
                                ...
                                if (transferModel.Players.getItem(transferModelPlayersIndex).Units != null) {
                                    ...
                                    for (var transferModelPlayerstransferModelPlayersIndexUnitsIndex = 0; transferModelPlayerstransferModelPlayersIndexUnitsIndex < transferModel.Players.getItem(transferModelPlayersIndex).Units.Count; transferModelPlayerstransferModelPlayersIndexUnitsIndex = (transferModelPlayerstransferModelPlayersIndexUnitsIndex + 1) | 0) {
                                        writer.Write(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex) != null);
                                        if (transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex) != null) {
                                            writer.Write$10(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).Hp);
                                            writer.Write(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).Position != null);
                                            if (transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).Position != null) {
                                                writer.Write$10(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).Position.X);
                                                writer.Write$10(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).Position.Y);
                                            }
                                            writer.Write$10(transferModel.Players.getItem(transferModelPlayersIndex).Units.getItem(transferModelPlayerstransferModelPlayersIndexUnitsIndex).UnitId);
                                        }
                                    }
                                }
                            }
            ...
            InternalRead: function (reader) {
                ...
                if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelDoorsIndex = 0; transferModelDoorsIndex < transferModelDoorsCount; transferModelDoorsIndex = (transferModelDoorsIndex + 1) | 0) {
                            var transferModelDoorsValue = null;
                            if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelMapIndex = 0; transferModelMapIndex < transferModelMapCount; transferModelMapIndex = (transferModelMapIndex + 1) | 0) {
                            var transferModelMapValue = null;
                            if (reader.ReadBoolean()) {
                    ...
                    if (reader.ReadBoolean()) {
                        ...
                        for (var transferModelPlayersIndex = 0; transferModelPlayersIndex < transferModelPlayersCount; transferModelPlayersIndex = (transferModelPlayersIndex + 1) | 0) {
                            ...
                            if (reader.ReadBoolean()) {
                                ...
                                if (reader.ReadBoolean()) {
                                    ...
                                    for (var transferModelPlayersValueUnitsIndex = 0; transferModelPlayersValueUnitsIndex < transferModelPlayersValueUnitsCount; transferModelPlayersValueUnitsIndex = (transferModelPlayersValueUnitsIndex + 1) | 0) {
                                        var transferModelPlayersValueUnitsValue = null;
                                        if (reader.ReadBoolean()) {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerGameStartedTransferMessageParser", {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerPlayerTurnMadeTransferMessageParser", {
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerYouConnectedTransferMessageParser", {
                ...
                if (transferModel != null) {
                    ...
                    if (transferModel.UnitsData != null) {
                        ...
                        for (var transferModelUnitsDataIndex = 0; transferModelUnitsDataIndex < transferModel.UnitsData.Count; transferModelUnitsDataIndex = (transferModelUnitsDataIndex + 1) | 0) {
                            writer.Write(transferModel.UnitsData.getItem(transferModelUnitsDataIndex) != null);
                            if (transferModel.UnitsData.getItem(transferModelUnitsDataIndex) != null) {
                                writer.Write$10(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).AttackDamage);
                                writer.Write$10(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).AttackDistance);
                                writer.Write(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).AttackFriendlyFire);
                                writer.Write$10(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).AttackRadius);
                                writer.Write$10(transferModel.UnitsData.getItem(transferModelUnitsDataIndex).Hp);
    ...
    Bridge.define("PixelRPG.Base.AdditionalStuff.ClientServer.ServerYourTurnTransferMessageParser", {
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ClientReceiveServerClientConnectedVisibleSystem", {
        inherits: [PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.ClientReceiveHandlerSystem$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage)],
        fields: {
            scene: null,
        ...
        ctors: {
            init: function () {
                this.availableAnimations = new (System.Collections.Generic.Dictionary$2(System.String,System.String))();
            },
            ctor: function (scene) {
                this.$initialize();
                PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.ClientReceiveHandlerSystem$1(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage).ctor.call(this, new LocomotorECS.Matching.Matcher().All([PixelRPG.Base.Components.VisiblePlayerComponent]));
                this.scene = scene;
            }
        },
        methods: {
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ClientReceiveServerCurrentStateAISystem", {
        ...
        methods: {
            DoAction$2: function (message, entity, gameTime) {
                ...
                for (var i = 0; i < simpleAI.Players.Count; i = (i + 1) | 0) {
                    simpleAI.Players.getItem(i).Free();
                }
                simpleAI.Players.clear();

                for (var i1 = 0; i1 < message.Players.Count; i1 = (i1 + 1) | 0) {
                    var player = PixelRPG.Base.Screens.AIPlayerState.Create();
                    simpleAI.Players.add(player);
                    player.LevelScore = message.Players.getItem(i1).LevelScore;
                    player.PlayerId = message.Players.getItem(i1).PlayerId;
                    player.TotalScore = message.Players.getItem(i1).TotalScore;

                    for (var j = 0; j < message.Players.getItem(i1).Units.Count; j = (j + 1) | 0) {
                        var unit = PixelRPG.Base.Screens.AIPlayerState.UnitSubMessage.Create();
                        player.Units.add(unit);
                        unit.Hp = message.Players.getItem(i1).Units.getItem(j).Hp;
                        unit.UnitId = message.Players.getItem(i1).Units.getItem(j).UnitId;
                        unit.Position = PixelRPG.Base.Screens.AIPlayerState.PointSubMessage.Create();
                        unit.Position.X = message.Players.getItem(i1).Units.getItem(j).Position.X;
                        unit.Position.Y = message.Players.getItem(i1).Units.getItem(j).Position.Y;
                    }
                }

                if (message.Exit != null) {
                    simpleAI.Exit = simpleAI.Exit || PixelRPG.Base.Screens.AIPoint.Create();
                    simpleAI.Exit.X = message.Exit.X;
                    simpleAI.Exit.Y = message.Exit.Y;
                }

                var mapIdx = 0;
                for (var x = 0; x < System.Array.getLength(simpleAI.Regions, 0); x = (x + 1) | 0) {
                    for (var y = 0; y < System.Array.getLength(simpleAI.Regions, 1); y = (y + 1) | 0) {
                        var map = message.Map.getItem(mapIdx);
                        mapIdx = (mapIdx + 1) | 0;
                        if (System.Nullable.eq(map, PixelRPG.Base.Screens.GameSceneConfig.UnknownRegionValue)) {
                            continue;
                        }

                        simpleAI.Regions.set([x, y], map);
                        if (System.Nullable.eq(map, PixelRPG.Base.Screens.GameSceneConfig.WallRegionValue)) {
            ...
            DoAction$2: function (message, entity, gameTime) {
                ...
                for (var i1 = 0; i1 < message.Players.Count; i1 = (i1 + 1) | 0) {
                    ...
                    for (var j = 0; j < player.Units.Count; j = (j + 1) | 0) {
                        ...
                        if (player.Units.getItem(j).Hp <= 0) {
                            ...
                            playerUnit.GetComponent(PixelRPG.Base.Components.UnitComponent).State = PixelRPG.Base.Assets.UnitState.Run;
                        }
                ...
                for (var x = 0; x < maze.Width; x = (x + 1) | 0) {
                    for (var y = 0; y < maze.Height; y = (y + 1) | 0) {
                        ...
                        var mapTile = message.Map.getItem(mapIdx);
                        mapIdx = (mapIdx + 1) | 0;
                        if (System.Nullable.eq(mapTile, PixelRPG.Base.Screens.GameSceneConfig.UnknownRegionValue)) {
                            if (fogTile == null) {
                        ...
                        if (System.Nullable.eq(mapTile, PixelRPG.Base.Screens.GameSceneConfig.WallRegionValue)) {
                            currentTile.Id = 17;
                        } else if (System.Nullable.eq(mapTile, PixelRPG.Base.Screens.GameSceneConfig.PathRegionValue)) {
                            currentTile.Id = 2;
                        }
                ...
                for (var i2 = 0; i2 < message.Doors.Count; i2 = (i2 + 1) | 0) {
                    var junction = message.Doors.getItem(i2);
                    var tile = maze.GetTile(junction.X, junction.Y);
                    tile.Id = 6;
                }

                if (message.Exit != null) {
                    var currentTile1 = maze.GetTile(message.Exit.X, message.Exit.Y);
                    if (currentTile1 == null) {
                        currentTile1 = new PixelRPG.Base.AdditionalStuff.TiledMap.Models.TiledTile();
                        maze.SetTile(message.Exit.X, message.Exit.Y, currentTile1);
                    }
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ClientReceiveServerGameStartedAISystem", {
        ...
        methods: {
            DoAction$2: function (message, entity, gameTime) {
                ...
                simpleAI.Exit != null ? simpleAI.Exit.Free() : null;
                simpleAI.Exit = null;
            }
        }
    });
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ClientRecieveServerYouConnectedAISystem", {
        ...
        methods: {
            DoAction$2: function (message, entity, gameTime) {
                ...
                $t = Bridge.getEnumerator(simpleAI.UnitDesription);
                try {
                    while ($t.moveNext()) {
                        var unitKVP = $t.Current;
                        unitKVP.value.Free();
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                ...
                for (var i = 0; i < message.UnitsData.Count; i = (i + 1) | 0) {
                    var unit = PixelRPG.Base.Screens.AIUnitDescription.Create();
                    simpleAI.UnitDesription.add(message.UnitsData.getItem(i).UnitId, unit);
                    unit.UnitType = message.UnitsData.getItem(i).UnitType;
                    unit.UnitId = message.UnitsData.getItem(i).UnitId;
                    unit.VisionRange = message.UnitsData.getItem(i).VisionRange;
                    unit.MoveRange = message.UnitsData.getItem(i).MoveRange;
                    unit.MaxHp = message.UnitsData.getItem(i).MaxHp;
                    unit.Hp = message.UnitsData.getItem(i).Hp;
                    unit.AttackDistance = message.UnitsData.getItem(i).AttackDistance;
                    unit.AttackRadius = message.UnitsData.getItem(i).AttackRadius;
                    unit.AttackDamage = message.UnitsData.getItem(i).AttackDamage;
                    unit.AttackFriendlyFire = message.UnitsData.getItem(i).AttackFriendlyFire;
                }
            }
        }
    });
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ClientSendClientConnectDoneAISystem", {
        inherits: [PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.ClientSendHandlerSystem$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage)],
        ctors: {
            ctor: function () {
                this.$initialize();
                PixelRPG.Base.AdditionalStuff.ClientServer.EntitySystems.ClientSendHandlerSystem$1(PixelRPG.Base.TransferMessages.ClientConnectTransferMessage).ctor.call(this, new LocomotorECS.Matching.Matcher().All([PixelRPG.Base.AdditionalStuff.BrainAI.Components.AIComponent]));
            }
        },
        methods: {
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ServerReceiveClientConnectHandler", {
        ...
        methods: {
            Handle$1: function (server, connectionKey, message) {
                ...
                server.Response.get(connectionKey).Enqueue(PixelRPG.Base.TransferMessages.ServerYouConnectedTransferMessage.Create().SetPlayerId(newPlayer.PlayerId).PopulateUnits(newPlayer.Units));

                $t = Bridge.getEnumerator(gameState.Players);
                try {
                    while ($t.moveNext()) {
                        var player = $t.Current;
                        server.Response.get(connectionKey).Enqueue(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.Create().SetData(player.value.PlayerId, player.value.PlayerName, gameState.MaxPlayersCount, gameState.Players.count).PopulateUnits(player.value.Units));
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                        $t.System$IDisposable$Dispose();
                ...
                gameState.Players.set(connectionKey, newPlayer);

                $t1 = Bridge.getEnumerator(gameState.Players);
                try {
                    while ($t1.moveNext()) {
                        var player1 = $t1.Current;
                        server.Response.get(player1.key).Enqueue(PixelRPG.Base.TransferMessages.ServerClientConnectedTransferMessage.Create().SetData(newPlayer.PlayerId, message.PlayerName, gameState.MaxPlayersCount, gameState.Players.count).PopulateUnits(newPlayer.Units));
                    }
                } finally {
                    if (Bridge.is($t1, System.IDisposable)) {
                        $t1.System$IDisposable$Dispose();
                ...
                if (gameState.Players.count === gameState.MaxPlayersCount) {
                    PixelRPG.Base.EntitySystems.ServerLogic.StartNewGame(gameState);

                    $t2 = Bridge.getEnumerator(gameState.Players);
                    try {
                        while ($t2.moveNext()) {
                            var player2 = $t2.Current;
                            var responses = server.Response.get(player2.key);
                            responses.Enqueue(PixelRPG.Base.TransferMessages.ServerGameStartedTransferMessage.Create().SetSize(System.Array.getLength(gameState.Map, 0), System.Array.getLength(gameState.Map, 1)));
                            responses.Enqueue(PixelRPG.Base.EntitySystems.ServerLogic.BuildCurrentStateForPlayer(gameState, player2.value));
                            responses.Enqueue(PixelRPG.Base.TransferMessages.ServerYourTurnTransferMessage.Create());
                        }
                    } finally {
                        if (Bridge.is($t2, System.IDisposable)) {
                            $t2.System$IDisposable$Dispose();
    ...
    Bridge.define("PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler", {
        ...
        methods: {
            Handle$1: function (server, connectionKey, message) {
                ...
                var gameState = server.Entity.GetComponent(PixelRPG.Base.Components.GameStateComponent);
                gameState.PlayersMoved.add(gameState.Players.get(connectionKey).PlayerId);
                $t = Bridge.getEnumerator(message.UnitActions);
                try {
                    while ($t.moveNext()) {
                        var actionKVP = $t.Current;
                        var fullId = PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId$1(gameState.Players.get(connectionKey).PlayerId, actionKVP.key);
                        gameState.CurrentTurn.set(fullId, PixelRPG.Base.EntitySystems.ServerRecieveClientTurnDoneHandler.UnitAction.Create());
                        gameState.CurrentTurn.get(fullId).NewPositionX = actionKVP.value.NewPosition.X;
                        gameState.CurrentTurn.get(fullId).NewPositionY = actionKVP.value.NewPosition.Y;
                        gameState.CurrentTurn.get(fullId).AttackDirectionX = ($t1 = actionKVP.value.AttackDirection) != null ? $t1.X : null;
                        gameState.CurrentTurn.get(fullId).AttackDirectionY = ($t2 = actionKVP.value.AttackDirection) != null ? $t2.Y : null;
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                        $t.System$IDisposable$Dispose();
                ...
                $t3 = Bridge.getEnumerator(gameState.Players);
                try {
                    while ($t3.moveNext()) {
                        var player = $t3.Current;
                        server.Response.get(player.key).Enqueue(PixelRPG.Base.TransferMessages.ServerPlayerTurnMadeTransferMessage.Create().SetPlayerId(gameState.Players.get(connectionKey).PlayerId));
                    }
                } finally {
                    if (Bridge.is($t3, System.IDisposable)) {
                        $t3.System$IDisposable$Dispose();
                ...
                if (System.Linq.Enumerable.from(gameState.PlayersMoved).count() !== gameState.MaxPlayersCount) {
                    return;
                }
                gameState.PlayersMoved.clear();

                var playersList = System.Linq.Enumerable.from(gameState.Players.getValues()).toList(PixelRPG.Base.Components.GameState.Player);
                FateRandom.Fate.GlobalFate.Shuffle(PixelRPG.Base.Components.GameState.Player, playersList);

                for (var i = 0; i < playersList.Count; i = (i + 1) | 0) {
                    var player1 = playersList.getItem(i);
                    for (var j = 0; j < player1.Units.Count; j = (j + 1) | 0) {
                        var unit = player1.Units.getItem(j);
                        var fullId1 = PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId(player1, unit);
                        if (!gameState.CurrentTurn.containsKey(fullId1) && unit.Hp > 0 && unit.Hp < unit.MaxHp) {
                            unit.Hp = (unit.Hp + 1) | 0;
                        }
                    }
                }
                ...
                for (var i1 = 0; i1 < playersList.Count; i1 = (i1 + 1) | 0) {
                    var player2 = playersList.getItem(i1);
                    for (var j1 = 0; j1 < player2.Units.Count; j1 = (j1 + 1) | 0) {
                        var unit1 = player2.Units.getItem(j1);
                        var fullId2 = PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId(player2, unit1);
                        if (!gameState.CurrentTurn.containsKey(fullId2) || unit1.Hp <= 0) {
                            continue;
                        }

                        var newPositionX = gameState.CurrentTurn.get(fullId2).NewPositionX;
                        var newPositionY = gameState.CurrentTurn.get(fullId2).NewPositionY;
                        var canMove = true;
                        if (newPositionX !== gameState.Exit.X || newPositionY !== gameState.Exit.Y) {
                            $t4 = Bridge.getEnumerator(gameState.Players);
                            try {
                                while ($t4.moveNext()) {
                                    var playerKVP = $t4.Current;
                                    var otherPlayer = playerKVP.value;
                                    for (var k = 0; k < otherPlayer.Units.Count; k = (k + 1) | 0) {
                                        var otherUnit = otherPlayer.Units.getItem(k);
                        ...
                        if (canMove) {
                            var distance = (Math.abs(((unit1.Position.X - newPositionX) | 0)) + Math.abs(((unit1.Position.Y - newPositionY) | 0))) | 0;

                            if (distance <= unit1.MoveRange) {
                                unit1.Position.X = newPositionX;
                                unit1.Position.Y = newPositionY;
                            }
                        }
                    }
                }

                for (var i2 = 0; i2 < playersList.Count; i2 = (i2 + 1) | 0) {
                    var player3 = playersList.getItem(i2);
                    for (var j2 = 0; j2 < player3.Units.Count; j2 = (j2 + 1) | 0) {
                        var unit2 = player3.Units.getItem(j2);
                        var fullId3 = PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId(player3, unit2);

                        if (!gameState.CurrentTurn.containsKey(fullId3) || unit2.Hp <= 0) {
                            continue;
                        }

                        if (gameState.CurrentTurn.get(fullId3).AttackDirectionX == null || gameState.CurrentTurn.get(fullId3).AttackDirectionY == null) {
                            continue;
                        }

                        if (Microsoft.Xna.Framework.Point.op_Equality(unit2.Position.$clone(), gameState.Exit.$clone())) {
                            continue;
                        }

                        var attackToX = (gameState.CurrentTurn.get(fullId3).NewPositionX + System.Nullable.getValue(gameState.CurrentTurn.get(fullId3).AttackDirectionX)) | 0;
                        var attackToY = (gameState.CurrentTurn.get(fullId3).NewPositionY + System.Nullable.getValue(gameState.CurrentTurn.get(fullId3).AttackDirectionY)) | 0;
                        var distance1 = Bridge.Int.clip32(System.Nullable.add(gameState.CurrentTurn.get(fullId3).AttackDirectionX, gameState.CurrentTurn.get(fullId3).AttackDirectionY));
                        if (System.Nullable.gt(distance1, unit2.AttackDistance)) {
                            continue;
                        }

                        $t5 = Bridge.getEnumerator(gameState.Players);
                        try {
                            while ($t5.moveNext()) {
                                var playerKVP1 = $t5.Current;
                                var otherPlayer1 = playerKVP1.value;
                                if (!unit2.AttackFriendlyFire && otherPlayer1.PlayerId === player3.PlayerId) {
                                    continue;
                                }

                                for (var k1 = 0; k1 < otherPlayer1.Units.Count; k1 = (k1 + 1) | 0) {
                                    var otherUnit1 = otherPlayer1.Units.getItem(k1);
                                    if (otherUnit1.Hp <= 0) {
                                        continue;
                                    }

                                    var distanceToAttackPoint = (Math.abs(((attackToX - otherUnit1.Position.X) | 0)) + Math.abs(((attackToY - otherUnit1.Position.Y) | 0))) | 0;
                                    if (distanceToAttackPoint > unit2.AttackRadius) {
                                        continue;
                                    }

                                    otherUnit1.Hp = (otherUnit1.Hp - unit2.AttackDamage) | 0;
                                }
                            }
                        } finally {
                ...
                $t6 = Bridge.getEnumerator(gameState.CurrentTurn);
                try {
                    while ($t6.moveNext()) {
                        var actionKVP1 = $t6.Current;
                        actionKVP1.value.Free();
                    }
                } finally {
                ...
                var allAtEnd = true;
                $t7 = Bridge.getEnumerator(gameState.Players);
                try {
                    while ($t7.moveNext()) {
                        var player4 = $t7.Current;
                        for (var i3 = 0; i3 < player4.value.Units.Count; i3 = (i3 + 1) | 0) {
                            var unit3 = player4.value.Units.getItem(i3);
                            var fullUnitId = PixelRPG.Base.EntitySystems.ServerLogic.GetFullUnitId(player4.value, unit3);
                ...
                $t8 = Bridge.getEnumerator(gameState.Players);
                try {
                    while ($t8.moveNext()) {
                        var player5 = $t8.Current;
                        var responses = server.Response.get(player5.key);
                        if (allAtEnd) {
                            responses.Enqueue(PixelRPG.Base.TransferMessages.ServerGameStartedTransferMessage.Create().SetSize(System.Array.getLength(gameState.Map, 0), System.Array.getLength(gameState.Map, 1)));
                        }

                        responses.Enqueue(PixelRPG.Base.EntitySystems.ServerLogic.BuildCurrentStateForPlayer(gameState, player5.value));
                        responses.Enqueue(PixelRPG.Base.TransferMessages.ServerYourTurnTransferMessage.Create());
                    }
                } finally {
