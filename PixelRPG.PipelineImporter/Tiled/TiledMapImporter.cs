namespace PixelRPG.PipelineImporter.Tiled
{
    ...
    using PixelRPG.PipelineImporter.Tiled.ImportModels;
    using PixelRPG.PipelineImporter.Utils;

    using CompressionMode = System.IO.Compression.CompressionMode;

    [ContentImporter(".tmx", DefaultProcessor = nameof(TiledMapProcessor), DisplayName = "Tiled Map Importer - PixelRPG")]
